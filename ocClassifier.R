...
# CART
set.seed(7)
fit.cart <- train(sml ~ .,as.data.frame(train.set), method="rpart", metric="ROC"
...
test.res <- predict(fit.rf,tests.set[,1:25])
confusionMatrix(test.res,tests.set$sml, positive = "G0")
